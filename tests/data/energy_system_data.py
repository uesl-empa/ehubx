...
class EnergySystem:
    ...
    def __init__(self) -> None:
        ...
        self._deactivated_self_sufficiency: Optional[SelfSufficiency] = None
    ...
    @property
    def self_sufficiency_deactivated(self) -> bool:
        """Whether the self-sufficiency module has been deactivated"""
        return self._deactivated_self_sufficiency is not None
    ...
    def deactivate_conv_techs(self) -> None:
        ...
        reactivation. It also triggers the deactivation of the solar
        technology module."""
    ...
    def deactivate_self_sufficiency(self) -> None:
        """Deactivate the self-sufficiency module. This resets the self-sufficiency
        data class but saves a copy for later reactivation."""
        raise NotImplementedError()
    ...
    def reactivate_self_sufficiency(self) -> None:
        """Reactivate the self-sufficiency module. This tries to overwrite
        the current self-sufficiency data class with the stashed version from
        deactivation."""
        raise NotImplementedError("Self-sufficiency not implemented")
