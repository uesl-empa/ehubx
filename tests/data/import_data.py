...
class Imports:
    ...
    def get_price(self, s: StageId, h: HubId, e: EcId) -> TimeSeries:
        """
        Get the parameter 'price' which denotes the price per ec unit that
    ...
    def set_price_def(self, s: StageId, h: HubId, e: EcId, price_def: Value) -> None:
        ...
        which denotes the price per ec unit that needs to be paid for
        ...
        :param e: ec
        :type e: EcId
        :param price_def: Default import price
    ...
    def set_co2_def(self, s: StageId, h: HubId, e: EcId, co2_def: Value) -> None:
        ...
        which denotes the embedded co2 per ec unit that arises for the
    ...
    def get_max(self, s: StageId, h: HubId, e: EcId) -> TimeSeries:
        ...
        :param e: ec
        :type e: EcId
        :return: Maximal allowed import
        :rtype: TimeSeries
        """
        self._check_ids(s, h, e, ExceptionKey.MAX_GET)
        return self._max[s, h, e]

    def set_max(self, s: StageId, h: HubId, e: EcId, t: TimeId, imp_max: Value) -> None:
        """
        ...
        :param t: Time
        :type t: TimeId
        :param imp_max: Maximal allowed import
        :type imp_max: Value
        """
    ...
    def set_max_def(self, s: StageId, h: HubId, e: EcId, max_def: Value) -> None:
        ...
        :param e: ec
        :type e: EcId
        :param max_def: Default maximal allowed import
        :type max_def: Value
        """
    ...
    def get_min(self, s: StageId, h: HubId, e: EcId) -> TimeSeries:
        ...
        :param e: ec
        :type e: EcId
        :return: Minimal allowed imports
        :rtype: TimeSeries
        """
        self._check_ids(s, h, e, ExceptionKey.MIN_GET)
        return self._min[s, h, e]

    def set_min(self, s: StageId, h: HubId, e: EcId, t: TimeId, imp_min: Value) -> None:
        """
        ...
        :param t: Time
        :type t: TimeId
        :param imp_min: Minimal allowed import
        :type imp_min: Value
        """
    ...
    def set_min_def(self, s: StageId, h: HubId, e: EcId, min_def: Value) -> None:
        ...
        :param e: ec
        :type e: EcId
        :param min_def: Default minimal allowed import
        :type min_def: Value
        """
    ...
    def get_sum_min(self, s: StageId, h: HubId, e: EcId, ecs: Ecs) -> Value:
        ...
        :type ecs: Ecs
        :return: Minimal import amount over the time horizon
        :rtype: Value
        """
    ...
    def set_sum_min(self, s: StageId, h: HubId, e: EcId, sum_min: Value) -> None:
        ...
        :param e: ec
        :type e: EcId
        :param sum_min: Minimal import amount over the time horizon
        :type sum_min: Value
        """
    ...
    def get_sum_max(self, s: StageId, h: HubId, e: EcId, ecs: Ecs) -> Value:
        ...
        :param ecs: Energy carriers
        :type ecs: Ecs
        :return: Maximal import amount over the time horizon
        :rtype: Value
        """
    ...
    def set_sum_max(self, s: StageId, h: HubId, e: EcId, sum_max: Value) -> None:
        ...
        :param e: ec
        :type e: EcId
        :param sum_max: Maximal import amount over the time horizon
        :type sum_max: Value
        """
    ...
    def _validate_max(self, ecs: Ecs, times: Times) -> None:
        ...
        for (s, h, e), imp_max in self._max.items():
            # Unit
            assert imp_max.unit is not None
            expected_unit = ecs.get_unit(e) / TimeUnit.H
            if not imp_max.unit.same_type_as(expected_unit):
                msg = (
                    f"Unit {imp_max.unit} of max[{s}, {h}, {e}] "
                    f"does not match expected unit {expected_unit}"
                )
                raise exceptions.DataException(
                    exc_key, [s, h, e], msg, module=LOG_MODULE_STR
            ...
            if imp_max.has_values:
                for t in times.ids:
                    if imp_max.get_value(t).is_negative:
    ...
    def _validate_min(self, ecs: Ecs, times: Times) -> None:
        ...
        for (s, h, e), imp_min in self._min.items():
            # Unit
            assert imp_min.unit is not None
            expected_unit = ecs.get_unit(e) / TimeUnit.H
            if not imp_min.unit.same_type_as(expected_unit):
                msg = (
                    f"Unit {imp_min.unit} of min[{s}, {h}, {e}] "
                    f"does not match expected unit {expected_unit}"
                )
                raise exceptions.DataException(
                    exc_key, [s, h, e], msg, module=LOG_MODULE_STR
            ...
            if imp_min.has_values:
                for t in times.ids:
                    if imp_min.get_value(t).is_negative:
