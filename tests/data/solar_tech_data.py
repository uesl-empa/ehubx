...
class ExceptionKey(Enum):
    ...
    AREACAPMININIT_VAL = (
        "validating 'cap_min' and 'cap_init' of Techs against 'area' of SolarData"
    )
...
class SolarTechs:
    ...
    # ------------------------- #
    def get_curtail_max_rel(self, s: StageId, x: TechId) -> Value:
        """
        ...
        :type x: TechId
        :return: Relative amount of maximal curtailment
        :rtype: Value
        """
        self._check_id(x, ExceptionKey.CURTAILMAXREL_GET)
        return self._curtail_max_rel.get((s, x), Value(DEF_CURTAILMAXREL))

    def set_curtail_max_rel(
        self, s: StageId, x: TechId, curtail_max_rel: Value
    ) -> None:
        """
        ...
        :param x: Id of solar technology
        :type x: TechId
        :param curtail_max_rel: Relative amount of maximal curtailment
        :type curtail_max_rel: Value
        """
        ...
        if not curtail_max_rel.unit.same_type_as(expected_unit):
            raise exceptions.UnitException(
                unit=str(curtail_max_rel.unit),
                msg=f"Invalid unit for curtail_max_rel[{s}, {x}]. "
    ...
    def __init__(self) -> None:
        ...
        self._curtail_max_rel: Dict[Tuple[StageId, TechId], Value] = {}
    ...
    def validate(
        ...
        self._validate_capmininit_area(stages, hubs, techs, conv_techs, solar_data)
    ...
    def _validate_in_ecs(
        self, conv_techs: ConversionTechs, solar_data: SolarData
    ) -> None:
