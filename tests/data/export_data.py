...
class Exports:
    ...
    def add_tuple(self, s: StageId, h: HubId, e: EcId, ec_unit: Unit) -> None:
        ...
        self._price[s, h, e].def_value = Value(DEF_PRICE, CurrencyUnit.CHF / ec_unit)
        self._co2[s, h, e].def_value = Value(DEF_CO2, MassUnit.KG / ec_unit)
        self._max[s, h, e].def_value = Value(DEF_MAX, (ec_unit / TimeUnit.H))
        self._min[s, h, e].def_value = Value(DEF_MIN, (ec_unit / TimeUnit.H))
    ...
    def get_price(self, s: StageId, h: HubId, e: EcId) -> TimeSeries:
        ...
        :param e: ec
        :type e: EcId
        :return: Export prices
        :rtype: TimeSeries
        """
        self._check_ids(s, h, e, ExceptionKey.PRICE_GET)
        return self._price[s, h, e]

    def set_price(self, s: StageId, h: HubId, e: EcId, t: TimeId, price: Value) -> None:
        """
        ...
        :param t: Time
        :type t: TimeId
        :param price: Export price
        :type price: Value
        """
        self._check_ids(s, h, e, ExceptionKey.PRICE_SET)
        self._price[s, h, e].set_value(t, price)

    def set_price_def(self, s: StageId, h: HubId, e: EcId, price_def: Value) -> None:
        """
        ...
        :param e: ec
        :type e: EcId
        :param price_def: Default export price
        :type price_def: Value
        """
    ...
    def get_co2(self, s: StageId, h: HubId, e: EcId) -> TimeSeries:
        ...
        :param e: ec
        :type e: EcId
        :return: Embedded CO2 values
        :rtype: TimeSeries
        """
        self._check_ids(s, h, e, ExceptionKey.CO2_GET)
        return self._co2[s, h, e]

    def set_co2(self, s: StageId, h: HubId, e: EcId, t: TimeId, co2: Value) -> None:
        """
        ...
        :param t: Time
        :type t: TimeId
        :param co2: Embedded CO2
        :type co2: Value
        """
        self._check_ids(s, h, e, ExceptionKey.CO2_SET)
        self._co2[s, h, e].set_value(t, co2)

    def set_co2_def(self, s: StageId, h: HubId, e: EcId, co2_def: Value) -> None:
        """
        ...
        :param e: ec
        :type e: EcId
        :param co2_def: Default embedded CO2
        :type co2_def: Value
        """
    ...
    def get_max(self, s: StageId, h: HubId, e: EcId) -> TimeSeries:
        ...
        :param e: ec
        :type e: EcId
        :return: Maximal allowed exports
        :rtype: TimeSeries
        """
        self._check_ids(s, h, e, ExceptionKey.MAX_GET)
        return self._max[s, h, e]

    def set_max(self, s: StageId, h: HubId, e: EcId, t: TimeId, exp_max: Value) -> None:
        """
        ...
        :param t: Time
        :type t: TimeId
        :param imp_max: Maximal allowed export
        :type imp_max: Value
        """
        self._check_ids(s, h, e, ExceptionKey.MAX_SET)
        self._max[s, h, e].set_value(t, exp_max)

    def set_max_def(self, s: StageId, h: HubId, e: EcId, max_def: Value) -> None:
        """
        ...
        :param e: ec
        :type e: EcId
        :param max_def: Default maximal allowed export
        :type max_def: Value
        """
    ...
    def get_min(self, s: StageId, h: HubId, e: EcId) -> TimeSeries:
        ...
        :param e: ec
        :type e: EcId
        :return: Minimal allowed exports
        :rtype: TimeSeries
        """
        self._check_ids(s, h, e, ExceptionKey.MIN_GET)
        return self._min[s, h, e]

    def set_min(self, s: StageId, h: HubId, e: EcId, t: TimeId, exp_min: Value) -> None:
        """
        ...
        :param t: Time
        :type t: TimeId
        :param imp_min: Minimal allowed export
        :type imp_min: Value
        """
        self._check_ids(s, h, e, ExceptionKey.MIN_SET)
        self._min[s, h, e].set_value(t, exp_min)

    def set_min_def(self, s: StageId, h: HubId, e: EcId, min_def: Value) -> None:
        """
        ...
        :param e: ec
        :type e: EcId
        :param min_def: Default minimal allowed export
        :type min_def: Value
        """
    ...
    # Property: sum_min #
    # ----------------- #
    def get_sum_min(self, s: StageId, h: HubId, e: EcId, ecs: Ecs) -> Value:
        """
        ...
        :param e: ec
        :type e: EcId
        :param ecs: Energy carriers data class
        :type ecs: Ecs
        :return: Minimal export amount over the time horizon
        :rtype: Value
        """
        self._check_ids(s, h, e, ExceptionKey.SUMMIN_GET)
        return self._sum_min.get((s, h, e), Value(DEF_SUMMIN, ecs.get_unit(e)))

    def set_sum_min(self, s: StageId, h: HubId, e: EcId, sum_min: Value) -> None:
        """
        ...
        :param e: ec
        :type e: EcId
        :param sum_min: Minimal export amount over the time horizon
        :type sum_min: Value
        """
    ...
    # Property: sum_max #
    # ----------------- #
    def get_sum_max(self, s: StageId, h: HubId, e: EcId, ecs: Ecs) -> Value:
        """
        ...
        :param e: ec
        :type e: EcId
        :param ecs: Energy carriers
        :type ecs: Ecs
        :return: Maximal export amount over the time horizon
        :rtype: Value
        """
        self._check_ids(s, h, e, ExceptionKey.SUMMAX_GET)
        return self._sum_max.get((s, h, e), Value(DEF_SUMMAX, ecs.get_unit(e)))

    def set_sum_max(self, s: StageId, h: HubId, e: EcId, sum_max: Value) -> None:
        """
        ...
        :param e: ec
        :type e: EcId
        :param sum_max: Maximal export amount over the time horizon
        :type sum_max: Value
        """
    ...
    def time_series(
        ...
        for (s, h, e), series in self._price.items():
            if series.has_values:
                all_series.append(
                    (TimeSeriesKind.EXPORTPRICE, s, (h.key, e.key), series)
                )
        # min
        for (s, h, e), series in self._min.items():
            if series.has_values:
                all_series.append((TimeSeriesKind.EXPORTMIN, s, (h.key, e.key), series))
        # max
        for (s, h, e), series in self._max.items():
            if series.has_values:
                all_series.append((TimeSeriesKind.EXPORTMAX, s, (h.key, e.key), series))
        # co2
        for (s, h, e), series in self._co2.items():
            if series.has_values:
                all_series.append((TimeSeriesKind.EXPORTCO2, s, (h.key, e.key), series))
        return all_series
    ...
    def set_time_series_val(
        ...
        if kind == TimeSeriesKind.EXPORTPRICE:
            h = HubId(ids[0])
            e = EcId(ids[1])
            unit = self._price[s, h, e].unit
            assert unit is not None
            self.set_price(s, h, e, t, Value(value, unit=Unit.get_def_unit(unit)))
        if kind == TimeSeriesKind.EXPORTMAX:
            h = HubId(ids[0])
            e = EcId(ids[1])
            unit = self._max[s, h, e].unit
            assert unit is not None
            self.set_max(s, h, e, t, Value(value, unit=Unit.get_def_unit(unit)))
        if kind == TimeSeriesKind.EXPORTMIN:
            h = HubId(ids[0])
            e = EcId(ids[1])
            unit = self._min[s, h, e].unit
            assert unit is not None
            self.set_min(s, h, e, t, Value(value, unit=Unit.get_def_unit(unit)))
        if kind == TimeSeriesKind.EXPORTCO2:
            h = HubId(ids[0])
            e = EcId(ids[1])
            unit = self._co2[s, h, e].unit
            assert unit is not None
            self.set_co2(s, h, e, t, Value(value, unit=Unit.get_def_unit(unit)))
    ...
    def __init__(self) -> None:
        ...
        self._sum_max: Dict[Tuple[StageId, HubId, EcId], Value] = {}
        self._sum_min: Dict[Tuple[StageId, HubId, EcId], Value] = {}
    ...
    def validate(self, stages: Stages, hubs: Hubs, ecs: Ecs, times: Times) -> None:
        ...
        self._validate_price(ecs, times)
        self._validate_co2(ecs, times)
        self._validate_max(ecs, times)
        self._validate_min(ecs, times)
        self._validate_minmax(times)
        self._validate_sum_max(ecs)
        self._validate_sum_min(ecs)
        self._validate_sum_minmax(ecs)
    ...
    def _validate_price(self, ecs: Ecs, times: Times) -> None:
        exc_key = ExceptionKey.PRICE_VAL.value
        for (s, h, e), price in self._price.items():
            # Unit
            assert price.unit is not None
            expected_unit = CurrencyUnit.CHF / ecs.get_unit(e)
            if not price.unit.same_type_as(expected_unit):
                msg = (
                    f"Unit {price.unit} of price[{s}, {h}, {e}] "
            ...
            if price.has_values:
                for t in times.ids:
                    if price.get_value(t).is_negative:
            ...
            if not price.has_values:
                ...
                if price_def.is_negative:
                    msg = f"{price_def} = price[{s}, {h}, {e}] < 0"
                    logging.log_warning(msg, module=LOG_MODULE_STR)

    def _validate_co2(self, ecs: Ecs, times: Times) -> None:
        exc_key = ExceptionKey.CO2_VAL.value
        for (s, h, e), co2 in self._co2.items():
            # Unit
            assert co2.unit is not None
            expected_unit = MassUnit.KG / ecs.get_unit(e)
            if not co2.unit.same_type_as(expected_unit):
                msg = (
                    f"Unit {co2.unit} of co2[{s}, {h}, {e}] "
                    f"does not match expected unit {expected_unit}"
                )
                raise exceptions.DataException(
                    exc_key, [s, h, e], msg, module=LOG_MODULE_STR
            ...
            if co2.has_values:
                for t in times.ids:
                    if co2.get_value(t).is_negative:
            ...
            if not co2.has_values:
                ...
                if co2_def.is_negative:
                    msg = f"{co2_def} = co2[{s}, {h}, {e}] < 0"
                    logging.log_warning(msg, module=LOG_MODULE_STR)

    def _validate_max(self, ecs: Ecs, times: Times) -> None:
        exc_key = ExceptionKey.MAX_VAL.value
        for (s, h, e), exp_max in self._max.items():
            # Unit
            assert exp_max.unit is not None
            expected_unit = ecs.get_unit(e) / TimeUnit.H
            if not exp_max.unit.same_type_as(expected_unit):
                msg = (
                    f"Unit {exp_max.unit} of max[{s}, {h}, {e}] "
                    f"does not match expected unit {expected_unit}"
                )
                raise exceptions.DataException(
                    exc_key, [s, h, e], msg, module=LOG_MODULE_STR
            ...
            if exp_max.has_values:
                for t in times.ids:
                    if exp_max.get_value(t).is_negative:
                        msg = f"{exp_max.get_value(t)} = max[{s}, {h}, {e}][{t}] < 0"
                        raise exceptions.DataException(
            ...
            if not exp_max.has_values:
                ...
                if exp_max_def.is_negative:
                    msg = f"{exp_max_def} = max[{s}, {h}, {e}] < 0"
                    raise exceptions.DataException(
                        exc_key, [s, h, e], msg, module=LOG_MODULE_STR
                    )

    def _validate_min(self, ecs: Ecs, times: Times) -> None:
        exc_key = ExceptionKey.MIN_VAL.value
        for (s, h, e), exp_min in self._min.items():
            # Unit
            assert exp_min.unit is not None
            expected_unit = ecs.get_unit(e) / TimeUnit.H
            if not exp_min.unit.same_type_as(expected_unit):
                msg = (
                    f"Unit {exp_min.unit} of min[{s}, {h}, {e}] "
                    f"does not match expected unit {expected_unit}"
                )
                raise exceptions.DataException(
                    exc_key, [s, h, e], msg, module=LOG_MODULE_STR
            ...
            if exp_min.has_values:
                for t in times.ids:
                    if exp_min.get_value(t).is_negative:
                        msg = f"{exp_min.get_value(t)} = min[{s}, {h}, {e}][{t}] < 0"
                        logging.log_warning(msg, module=LOG_MODULE_STR)
                        break
            ...
            if exp_min.has_values or exp_max.has_values:
                for t in times.ids:
                    if exp_min.get_value(t) > exp_max.get_value(t):
                        msg = (
                            f"{exp_min.get_value(t)} = min[{s}, {h}, {e}]"
                            f"[{t}] > max[{s}, {h}, {e}][{t}] = "
    ...
    def _validate_sum_max(self, ecs: Ecs) -> None:
        exc_key = ExceptionKey.SUMMAX_VAL.value
        for (s, h, e), sum_max in self._sum_max.items():
            # Unit
            expected_unit = ecs.get_unit(e)
            if not sum_max.unit.same_type_as(expected_unit):
                msg = (
                    f"Unit {sum_max.unit} of sum_max[{s}, {h}, {e}] "
                    f"does not match expected unit {expected_unit}"
                )
                raise exceptions.DataException(
                    exc_key, [s, h, e], msg, module=LOG_MODULE_STR
            ...
            if sum_max.is_negative:
                msg = f"{sum_max} = sum_max[{s}, {h}, {e}] < 0"
                raise exceptions.DataException(
                    exc_key, [s, h, e], msg, module=LOG_MODULE_STR
                )

    def _validate_sum_min(self, ecs: Ecs) -> None:
        exc_key = ExceptionKey.SUMMIN_VAL.value
        for (s, h, e), sum_min in self._sum_min.items():
            # Unit
            expected_unit = ecs.get_unit(e)
            if not sum_min.unit.same_type_as(expected_unit):
                msg = (
                    f"Unit {sum_min.unit} of sum_min[{s}, {h}, {e}] "
                    f"does not match expected unit {expected_unit}"
                )
                raise exceptions.DataException(
                    exc_key, [s, h, e], msg, module=LOG_MODULE_STR
            ...
            if sum_min.is_negative:
                msg = f"{sum_min} = sum_min[{s}, {h}, {e}] < 0"
                logging.log_warning(msg, module=LOG_MODULE_STR)

    def _validate_sum_minmax(self, ecs: Ecs) -> None:
        exc_key = ExceptionKey.SUMMINMAX_VAL.value
        for s, h, e in self.tuples:
            sum_min = self.get_sum_min(s, h, e, ecs)
            sum_max = self.get_sum_max(s, h, e, ecs)
    ...
    def _check_ids(self, s: StageId, h: HubId, e: EcId, where: ExceptionKey) -> None:
        if (s, h, e) not in self._tuples:
            msg = (
                f"Encountered tuple ({s}, {h}, {e}) which is not an export "
