...
from ehubx.parser import csv_parser, tech_parser, yaml_parser
    ...
    if os.path.isfile(irradiation_file_path):
        ...
        for s, e in df_irradiation.columns:
            for t in df_irradiation.index:
                ...
                solar_data.set_irradiation(StageId(s), EcId(e), TimeId(t), irradiation)
    # Logging
...
def _parse_tech(
    tech_node: yaml_parser.YamlDictNode, stages: Stages, solar_techs: SolarTechs
) -> None:
    # tech_id
