...
def parse_primary(
    network_subpath: str, energy_system: EnergySystem, stages: Stages
) -> NetworkTechs:
    ...
    for net_tech_node in net_techs_node:
        _parse_net_tech_primary(net_tech_node, energy_system, stages, net_techs)
    # Logging
    _log(net_techs)
    # Return
    return net_techs
...
def _parse_net_tech_primary(
    ...
    # ec
    ec = EcId(
        yaml_parser.parse_mandatory_str_value_from_dict_node(net_tech_node, YAMLKEY_EC)
    )
...
def parse_secondary(
    link_root_node: Optional[yaml_parser.YamlNode], net_techs: NetworkTechs
) -> None:
...
def _parse_net_tech_lists(
    ...
    for net_tech_list_node in net_tech_lists_node:
        net_tech_list_id = yaml_parser.parse_mandatory_str_value_from_dict_node(
    ...
    if net_tech_params_node is not None:
        ...
        for net_tech_node in net_tech_params_node:
            _parse_net_tech_secondary(
                net_tech_node, link_id, net_techs, allowed_net_techs
            )
