...
def parse(
    network_subpath: str, stages: Stages
    ...
    for start_hub_node in start_hubs_node:
        start_hub_id_str = yaml_parser.parse_mandatory_str_value_from_dict_node(
        ...
        for end_hub_node in end_hubs_node:
            end_hub_id_str = yaml_parser.parse_mandatory_str_value_from_dict_node(
            ...
            for link_node in links_node:
                _parse_link_primary(
                    link_node, start_hub_id, end_hub_id, net_links, stages
                )
    # Logging
    _log(net_links)
    # Return
...
def _parse_ec_params(
    ...
    # sum_min_forward
    sum_min_forward = yaml_parser.parse_optional_yeardep_float_from_dict_node(
    ...
    # sum_min_backward
    sum_min_backward = yaml_parser.parse_optional_yeardep_float_from_dict_node(
    ...
    # sum_max_forward
    sum_max_forward = yaml_parser.parse_optional_yeardep_float_from_dict_node(
    ...
    # sum_max_backward
    sum_max_backward = yaml_parser.parse_optional_yeardep_float_from_dict_node(
