...
from ehubx.writer import solar_writer, wind_writer
...
def _format_tech(
    ...
    for s in energy_system.stages.ids_in_order:
        ...
        for h in energy_system.hubs.ids_in_order:
            ...
            conv_tech_cost_opex_out = value(var[s.key, h.key, x.key], exception=False)
...
def write_data_time_series(
    conv_techs: ConversionTechs, times: Times, dir_path: str
) -> None:
    """
