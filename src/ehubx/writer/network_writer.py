...
"""Entry name for network tech parameter 'trans_loss' in result files"""
...
def format_all(
    ...
    cols_to_drop_st = [COL_TECH, COL_WINDPARK, COL_LOADSHIFT]
...
def write_time_series(net_links: NetworkLinks, times: Times, dir_path: str) -> None:
    ...
    :param net_links: The NetworkLinks data object whose time series are to be
        written
