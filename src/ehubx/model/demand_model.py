...
def build(model: Model, stages: Stages, demands: Demands, times: Times
          ) -> None:
    """
    ...
    demand_sum_per_ts = [
        sum([demands.get_demand(s2, h, e).get_value(t)
