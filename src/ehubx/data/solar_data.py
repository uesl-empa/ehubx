...
class SolarData:
    ...
    def get_irradiation(self, s: StageId, e: EcId) -> TimeSeries:
        ...
        :param e: Solar ec
        :type e: EcId
        :return: Irradiation profile [kW/m^2]
        :rtype: TimeSeries
        """
        if (s, e) not in self._irradiation:
            series = TimeSeries()
            series.def_value = DEF_IRRADIATION
            return series
    ...
    def set_irradiation(self, s: StageId, e: EcId, t: TimeId,
        ...
        :param t: Timestep
        :type t: TimeId
        :param irradiation: Irradiation level [kW/m^2]
        :type irradiation: float
        """
        if (s, e) not in self._irradiation:
            self._irradiation[s, e] = TimeSeries()
            self._irradiation[s, e].def_value = DEF_IRRADIATION
    ...
    def set_irradiation_def(self, s: StageId, e: EcId,
        ...
        :param e: Solar ec
        :type e: EcId
        :param irradiation_def: Default irradiation level [kW/m^2]
        :type irradiation_def: float
        """
        if (s, e) not in self._irradiation:
            self._irradiation[s, e] = TimeSeries()
    ...
    def clear_irradiation(self) -> None:
        """
    ...
    # Property: area #
    # -------------- #
    def get_area(self, s: StageId, h: HubId, e: EcId) -> float:
        """
        ...
        :rtype: float
        """
        return self._area.get((s, h, e), DEF_AREA)

    def set_area(self, s: StageId, h: HubId, e: EcId, area: float) -> None:
        """
    ...
    def set_time_series_val(self, kind: TimeSeriesKind, s: StageId,
        ...
        if kind == TimeSeriesKind.SOLARIRRAD:
            e = EcId(ids[0])
            self.set_irradiation(s, e, t, value)
    ...
    def __init__(self) -> None:
        ...
        self._area: Dict[Tuple[StageId, HubId, EcId], float] = {}
